  ...
  return (
    <div className="space-y-8">
      <div className="rounded-[2rem] border border-white/10 bg-white/5 p-6">
        ...
        <p className="mt-5 text-base leading-8 text-slate-100">{question.prompt}</p>
      ...
      <div className="flex flex-wrap gap-4">
        ...
        <Link
          href="/chat"
          className="rounded-full border border-sky-400/30 bg-sky-400/10 px-5 py-3 text-sm font-semibold text-sky-100 transition hover:bg-sky-400/20"
        >
